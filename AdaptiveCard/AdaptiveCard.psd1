@{
    ...
    GUID = '9146a455-536b-4a27-ac89-19a78c0803f8'

    # Author of this module
    Author = 'Aleksey Abramov'

    # Company or vendor of this module
    CompanyName = 'alxcreate'

    # Copyright statement for this module
    Copyright = '(c) 2024 Aleksey Abramov. All rights reserved.'

    # Description of the functionality provided by this module
    Description = 'Create Adaptive Cards in PowerShell with different elements'
